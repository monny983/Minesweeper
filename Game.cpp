...
bool isNeighbour(char helpingBoard[max_X_coordinate][max_Y_coordinate], int currentElementX, int currentElementY, int possibleNeighbourX,
    int possibleNeighbourY) {
...
bool openSquare(char playerBoard[max_X_coordinate][max_Y_coordinate], char helpingBoard[max_X_coordinate][max_Y_coordinate],
    int x_coordinate, int y_coordinate, int matrix_dimension) {
